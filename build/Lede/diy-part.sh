...
sed -i '$a src-git kiddin9 https://dl.openwrt.ai/packages-23.05/x86_64/packages/' feeds.conf.default
sed -i '$a src-git small https://github.com/kenzok8/small' feeds.conf.default
sed -i '$a src-git openwrt_kmod https://mirrors.cloud.tencent.com/lede/snapshots/targets/x86/64/kmods/' feeds.conf.default

# 后台IP设置
export Ipv4_ipaddr="192.168.100.1"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="shine"                # 修改主机名称为OpenWrt-123(填0为不作修改)
